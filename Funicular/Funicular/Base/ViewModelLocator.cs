...
namespace Funicular.Base
{
    public static class ViewModelLocator
    {
        ...
        static ViewModelLocator()
        {
            ...
            Xamarin.Forms.DependencyService.RegisterSingleton<INavigationService>(
                new NavigationService(settingsService));
            ...
            //Xamarin.Forms.DependencyService.RegisterSingleton<IDependencyService>(
            //    new Services.Dependency.DependencyService());
